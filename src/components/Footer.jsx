...
return (
<footer className=" text-white py-10 mt-10 w-full">
<div className="max-w-6xl mx-auto px-4">
<div className="flex flex-col items-center">
<h3 className="text-xl font-medium mb-6 font-semibold text-black">Connect With Me</h3>
...
className="bg-white p-2 rounded-full hover:transform hover:-translate-y-1 transition-transform duration-300"
>
